...
## 装備していないアイテムのエンチャントが特徴と体質に表示されることがある問題
...
## 錬金術・調合・ガロクの槌で大事なもの指定が無視されている問題
問題というほどでもない気がするが
...
rpref(10 + step * 2) = ci, inv(3, ci)の行のすぐ下に
 ...
 snd 17
を追加
## 掲示板から依頼主の元に飛んで足元の罠で死んだ場合も依頼が受けられる問題
...
## NPCのインベントリを見たとき、(利腕)の表示が実際と食い違う問題
...
## ポピーからアイテムを受け取れたり、ブリーダーなどに指定できる問題
