...
*PCのスポットライトが死亡後も下1/3だけ残る問題 [#mcba79ef]
...
*F11のキャラダンプ機能でHspError 23が発生する問題 [#mbbfd042]
...
*サイズが小さいマップでボール系魔法を唱えると落ちることがある問題 [#u0208631]
...
*マップフィート情報がオーバーフローする問題 [#f0f9d5f8]
...
*乗馬されているペットが他のキャラを押しのけたと表示される問題 [#u7236da4]
cell_swap命令内
...
*来客用の椅子やマイチェアが壁で埋まっていても来客イベントでそこに座ってしまう問題 [#o84b2feb]
